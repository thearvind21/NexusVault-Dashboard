    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4 py-8 bg-[#0A0A0F] relative overflow-hidden">
            ...
            <motion.div
                ...
                className="absolute top-1/4 left-1/4 w-64 h-64 md:w-96 md:h-96 bg-blue-500/[0.06] rounded-full blur-3xl"
            />
            <motion.div
                animate={{ y: [0, 15, 0], x: [0, -10, 0] }}
                transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
                className="absolute bottom-1/4 right-1/4 w-48 h-48 md:w-80 md:h-80 bg-violet-500/[0.06] rounded-full blur-3xl"
            />
          ...
          shadow-2xl shadow-black/40"
            >
                ...
                >
                    ...
                    <div className="mt-1 h-0.5 w-12 mx-auto bg-gradient-to-r from-blue-500 to-violet-500 rounded-full" />
                </motion.div>

                <div className="mb-6 text-center">
                    <h2 className="text-lg md:text-xl font-semibold text-white">Welcome back</h2>
                    <p className="text-sm text-slate-400 mt-1">Sign in to your vault</p>
                </div>
